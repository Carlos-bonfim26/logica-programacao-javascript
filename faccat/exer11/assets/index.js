alert("vendo o percentual de votos da eleição")
...
let votos = validos + brancos + nulos;
validos = validos / votos * 100;
brancos = brancos / votos *100;
nulos =  nulos / votos * 100;

alert(`a quantidade de votos totais foi de ${votos} votos, e o percentual de votos brancos é de ${brancos}%, de votos nulos é de ${nulos}%, e a de votos válidos é de ${validos}%`);